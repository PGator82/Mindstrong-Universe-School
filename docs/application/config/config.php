...
$_http_host = (isset($_SERVER['HTTP_X_FORWARDED_HOST']) && $_SERVER['HTTP_X_FORWARDED_HOST'] !== '')
    ? $_SERVER['HTTP_X_FORWARDED_HOST']
    : $_SERVER['HTTP_HOST'];
$config['base_url'] = ($_is_https ? 'https' : 'http') . '://' . $_http_host;
...
|
*/
$config['index_page'] = ''; // Blank because .htaccess removes index.php from URLs
...
*/
$config['proxy_ips'] = '*'; // Trust Railway's reverse proxy
