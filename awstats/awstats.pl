...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/mindstro/domains/mindstronguniverse.org/awstats/.data"
	# Other possible directories :				"/usr/local/etc/awstats",
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/mindstro/domains/mindstronguniverse.org/awstats/.data",
